...
import { Select, Input, Form } from '@alifd/next';
              ...
              fields={[
                ...
                },
                {
                  ...
                  render: (ctx) => {
                    ...
                    if(fruitValue === 'apple') {
                      return <Select placeholder="请选择" style={{width: 150}}>
      ...
      render() {
        return (
          <RcFieldForm
            ...
            <RuleTree
              rootRelations={
                [{text: '与', value: 'and'}, {text: '或', value: 'or'}]
              }
              relations={
                [{text: '或', value: 'or'}]
              }
...
<ul>
  <li>
    <a target="_blank" href="https://work.alibaba-inc.com/work/u/157158">
      <img style={{verticalAlign: 'middle'}} width="20" src="https://work.alibaba-inc.com/photo/157158.40x40.xz.jpg" /> @成宣</a>
      <a target="_blank" href="dingtalk://dingtalkclient/action/sendmsg?dingtalk_id=kakuyogy">
      <img style={{verticalAlign: 'middle'}} width="20" src="https://img.alicdn.com/tfs/TB18HtyiyqAXuNjy1XdXXaYcVXa-24-24.svg" /> 成宣（写CRUD，就用Sula）</a>
  </li>
  <li>
    <a target="_blank" href="https://work.alibaba-inc.com/work/u/116642">
    <img style={{verticalAlign: 'middle'}} width="20" src="https://work.alibaba-inc.com/photo/116642.40x40.xz.jpg" /> @兼续</a>
    <a target="_blank" href="dingtalk://dingtalkclient/action/sendmsg?dingtalk_id=rdmclin2">
    <img style={{verticalAlign: 'middle'}} width="20" src="https://img.alicdn.com/tfs/TB18HtyiyqAXuNjy1XdXXaYcVXa-24-24.svg" /> 兼续(学前端就上Bigfish官网)</a>
  </li>
</ul>
